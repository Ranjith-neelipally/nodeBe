...
const renderAcceptedBlock = (accepted: Record<string, unknown>) => {
        ...
        .map(
          (route) => {
            const routeRequiresAuth =
              "requiresAuth" in route ? route.requiresAuth : section.requiresAuth;
            ...
            <article class="route-card">
              ...
              ${renderAcceptedBlock(route.accepted as Record<string, unknown>)}
            </article>
          `;
          },
        )
